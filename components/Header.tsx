              ...
              <div className="space-y-0.5">
                ...
                {user && user.role === "admin" && (
                  <a
                    href="/admin"
                    onClick={toggleMenu}
                    className="flex items-center space-x-3 px-3 py-2.5 rounded-lg bg-gradient-to-r from-purple-600 to-purple-700 text-white hover:from-purple-700 hover:to-purple-800 transition-all duration-200 hover:scale-[1.02]"
                  >
                    <Crown className="w-4 h-4" />
