...
export default function EventPage() {
  ...
  const { data: similarEventsData } = useSimilarEvents(eventId);
  const otherEvents = similarEventsData || [];
            ...
            <div className="lg:col-span-2 space-y-6">
                ...
                <Button
                  ...
                  onClick={() => {
                    ...
                    const endDate = new Date(
                      eventDataAny.end_date ||
                        eventDataAny.EndDate ||
                        eventDataAny.endDate ||
                        startDate
                    );
              ...
              <div>
                          ...
                          {event.manual_description
                            ...
                            .map((paragraph: string, index: number) => (
                              <span key={index}>
                                {paragraph}
                                {index <
                                  event.manual_description!.split("\n").length -
                                    1 && <br />}
                              </span>
                            ))}
                        </p>
                ...
                event.coordinates.lng !== 3.4219 ? (
                  <>
                    {/* Real Google Map with Loading State */}
                    <div className="rounded-lg h-64 overflow-hidden mb-4 relative">
                      {mapLoading && (
                        <div className="absolute inset-0 bg-gray-800 border border-gray-700 rounded-lg flex items-center justify-center z-10">
                          <div className="text-center">
                            <div className="w-8 h-8 border-2 border-[#D72638] border-t-transparent rounded-full animate-spin mx-auto mb-3"></div>
                      ...
                      <iframe
                        ...
                        onLoad={() => {
                          // Add a small delay to ensure the map content is fully loaded
      ...
      <PaymentModal
        ...
        event={{
          ...
          start_time:
            ...
            eventDataAny.startTime,
          end_time:
            eventDataAny.end_time ||
            eventDataAny.EndTime ||
            eventDataAny.endTime,
