...
export default function MyEventsPage() {
    ...
    try {
      ...
      const transformedTickets = Array.isArray(rawTickets)
        ? rawTickets.map((ticket: any) => {
            // More robust event data extract
            ...
            return {
              ...
              qrData: ticket.qr_data || ticket.QRData || "",
              attendeeData: {
                fullName:
  ...
  // Show sign-in required only after we've confirmed user is not authenticated
  if (!isAuthenticated) {
    return (
      <div className="min-h-screen bg-[#0D0D0D] text-white">
        <Header />
              ...
              {upcomingTickets.length > 0 ? (
                <>
                  <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-3 sm:gap-0">
                    ...
                    <Button
                      ...
                      variant="outline"
                      size="sm"
                      className="flex items-center gap-2 bg-[#D72638] text-white border-[#D72638]  text-xs sm:text-sm px-3 py-2 w-full sm:w-auto justify-center"
                    >
                      {downloadingAll ? (
                ...
                <Card className="bg-[#1a1a1a] border-gray-800">
                  <CardContent className="p-6 sm:p-12 text-center">
                    ...
                    <a
                      href="/"
                      className="inline-flex items-center px-4 py-2 bg-[#D72638] text-white rounded-lg  transition-colors text-sm sm:text-base"
                    >
                      Explore Events
                    </a>
                  </CardContent>
